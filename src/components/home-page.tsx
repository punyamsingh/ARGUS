 ...
 * surface — same page, same studio, with the hero reframed and the in-page
 * anchors kept on whichever route you're already on, so a walkthrough can't
 * fall out of demo mode by clicking "How it works".
 */
      ...
      <main className="relative flex-1">
        ...
        <section className="mx-auto max-w-3xl px-6 pb-12 pt-16 text-center lg:pt-24">
          ...
          <p className="rise mx-auto mt-6 max-w-xl text-balance text-lg leading-relaxed text-muted">
            {demo ? (
              <>
                A real meeting, a fixed set of public sources, and the same model
                that runs in production. Press Generate and the brief is written
                live — cited, in seconds, with nothing pre-written.
              </>
            ) : (
              <>
